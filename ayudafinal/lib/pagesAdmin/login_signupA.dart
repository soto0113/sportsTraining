...
class LoginSignUpPageA extends StatefulWidget {
  LoginSignUpPageA({this.auth, this.onSignedIn});

  final BaseAuth auth;
  final VoidCallback onSignedIn;

  @override
  State<StatefulWidget> createState() => new _LoginSignUpPageAState();
}

enum FormMode { LOGIN, SIGNUP }

class _LoginSignUpPageAState extends State<LoginSignUpPageA> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        appBar: new AppBar(
          title: new Text('LOGIN ADMINISTRADOR'),
        ),
        body: Stack(
          children: <Widget>[
            _showBody(),
  ...
  Widget _showLogo() {
    return new Hero(
      ...
      child: Container(
              height: 300,
              child: Image(
                image: AssetImage("imagenes/admin.png"),
                fit: BoxFit.contain,
              ),
            ),/*Padding(
